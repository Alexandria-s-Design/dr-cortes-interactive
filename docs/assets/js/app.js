...
const DECADE_INTROS = {
    '1950s': 'In post-World War II America, a young man from Kansas City set out on a path that would help shape how a nation thinks about diversity. From UC Berkeley to Columbia Journalism, from Fort Gordon to a Phoenix newsroom — every step was preparation for the road ahead.',
    '1960s': 'You might say the sixties made Carlos Cort\u00e9s a historian. A Ford Foundation fellowship took him to Brazil. A Ph.D. from New Mexico gave him the tools. And in 1968, UC Riverside hired him as a professor of history, giving him a stage that would last fifty-seven years.',
    ...
    '1980s': 'By now, the world was calling. PBS wanted documentaries. Harvard wanted lectures. Japan wanted perspective. The Distinguished California Humanist Award in 1980 signaled what many already knew: Carlos Cort\u00e9s had become an all-purpose multiculturalist.',
    ...
    '2020s': 'Zombie Time — because he refuses to stop. An anti-racism vision statement for Riverside. A consulting role at the Cheech museum. Cultural work on Puss in Boots: The Last Wish. A debut novel at 91. And now, the Multilingual Educator Hall of Fame. The story continues.'
};
...
const DECADE_INTROS_I18N = {
    es: {
        '1950s': 'En la Am\u00e9rica de la posguerra de la Segunda Guerra Mundial, un joven de Kansas City emprendi\u00f3 un camino que ayudar\u00eda a moldear la forma en que una naci\u00f3n piensa sobre la diversidad. De UC Berkeley a la Escuela de Periodismo de Columbia, del servicio militar a una redacci\u00f3n en Phoenix \u2014 cada paso fue preparaci\u00f3n para el camino que ven\u00eda.',
        '1960s': 'Se podr\u00eda decir que los sesenta convirtieron a Carlos Cort\u00e9s en historiador. Una beca de la Fundaci\u00f3n Ford lo llev\u00f3 a Brasil. Un doctorado de Nuevo M\u00e9xico le dio las herramientas. Y en 1968, UC Riverside lo contrat\u00f3 como profesor de historia, d\u00e1ndole un escenario que durar\u00eda cincuenta y siete a\u00f1os.',
        ...
        '1980s': 'Para entonces, el mundo llamaba. PBS quer\u00eda documentales. Harvard quer\u00eda conferencias. Jap\u00f3n quer\u00eda perspectiva. El Premio Distinguido Humanista de California en 1980 se\u00f1al\u00f3 lo que muchos ya sab\u00edan: Carlos Cort\u00e9s se hab\u00eda convertido en un multiculturalista todoterreno.',
        ...
        '2020s': 'Tiempo Zombie \u2014 porque \u00e9l se niega a parar. Una declaraci\u00f3n contra el racismo para Riverside. Un rol de consultor\u00eda en el museo Cheech. Trabajo cultural en El Gato con Botas: El \u00daltimo Deseo. Una novela debut a los 91. Y ahora, el Sal\u00f3n de la Fama del Educador Multiling\u00fce. La historia contin\u00faa.'
    },
    pt: {
        '1950s': 'Na Am\u00e9rica do p\u00f3s-Segunda Guerra Mundial, um jovem de Kansas City embarcou em um caminho que ajudaria a moldar como uma na\u00e7\u00e3o pensa sobre diversidade. De UC Berkeley \u00e0 Escola de Jornalismo de Columbia, do servi\u00e7o militar a uma reda\u00e7\u00e3o em Phoenix \u2014 cada passo foi prepara\u00e7\u00e3o para o caminho adiante.',
        '1960s': 'Pode-se dizer que os anos sessenta fizeram de Carlos Cort\u00e9s um historiador. Uma bolsa da Funda\u00e7\u00e3o Ford o levou ao Brasil. Um doutorado do Novo M\u00e9xico lhe deu as ferramentas. E em 1968, UC Riverside o contratou como professor de hist\u00f3ria, dando-lhe um palco que duraria cinquenta e sete anos.',
        ...
        '1980s': 'A essa altura, o mundo chamava. PBS queria document\u00e1rios. Harvard queria palestras. O Jap\u00e3o queria perspectiva. O Pr\u00eamio Distinto Humanista da Calif\u00f3rnia em 1980 sinalizou o que muitos j\u00e1 sabiam: Carlos Cort\u00e9s havia se tornado um multiculturalista vers\u00e1til.',
        ...
        '2020s': 'Tempo Zumbi \u2014 porque ele se recusa a parar. Uma declara\u00e7\u00e3o antirracismo para Riverside. Um papel de consultoria no museu Cheech. Trabalho cultural em Gato de Botas: O \u00daltimo Pedido. Um romance de estreia aos 91. E agora, o Hall da Fama do Educador Multil\u00edngue. A hist\u00f3ria continua.'
    }
};
