export const ENTRIES_ES = {
  ...
  'B.A., Communications and Public Policy (Phi Beta Kappa), UC Berkeley': {
    ...
    desc: 'Se graduó de la Universidad de California, Berkeley con un B.A. en Comunicaciones y Políticas Públicas. Fue admitido en Phi Beta Kappa por su destacado rendimiento académico.'
  },
  ...
  'Public Information Specialist, Fort Gordon, Georgia': {
    ...
    desc: 'Sirvió como Especialista en Información Pública en Fort Gordon, Georgia. El servicio militar le proporcionó experiencia en comunicaciones institucionales y asuntos públicos.'
  },
  ...
  'Bachelor of Foreign Trade, American Institute for Foreign Trade': {
    ...
    desc: 'Obtuvo una Licenciatura en Comercio Exterior del American Institute for Foreign Trade en Glendale, Arizona. Este título reflejó su creciente interés en los asuntos internacionales y América Latina.'
  },
  ...
  'Ph.D., History, University of New Mexico': {
    ...
    desc: 'Recibió su Ph.D. en Historia de la Universidad de Nuevo México. Su tesis examinó la política regional en el sur de Brasil a mediados del siglo XX.'
  },
  ...
  'Taught UCR\'s First Chicano History Course': {
    ...
    desc: 'Impartió el primer curso de Historia Chicana de UCR, siendo pionero en el desarrollo de los Estudios Chicanos como disciplina académica en UC Riverside. El curso examinó las experiencias históricas de los mexicoamericanos desde el período colonial hasta el movimiento chicano contemporáneo.'
  },
  'Chair, UCR Latin American Studies Program': {
    title: 'Director del Programa de Estudios Latinoamericanos de UCR',
    desc: 'Se convirtió en director del Programa de Estudios Latinoamericanos de UCR, sirviendo hasta 1972. Proporcionó liderazgo académico en un área de creciente interés académico y político.'
  },
  'Ethnic Content Textbook Task Force, California State Department of Education': {
    title: 'Grupo de Trabajo sobre Contenido Étnico en Libros de Texto, Departamento de Educación del Estado de California',
    desc: 'Participó en el Grupo de Trabajo sobre Contenido Étnico en Libros de Texto del Departamento de Educación del Estado de California. Este primer esfuerzo estatal para evaluar la representación étnica en los libros de texto ayudó a establecer estándares que influyeron en la publicación de libros de texto a nivel nacional.'
  },
  'Chair, UCR Mexican American Studies Program': {
    title: 'Director del Programa de Estudios México-Americanos de UCR',
    desc: 'Se convirtió en director del Programa de Estudios México-Americanos de UCR (posteriormente renombrado Estudios Chicanos), sirviendo hasta 1979. Lideró el programa durante un período formativo de crecimiento e institucionalización.'
  },
  'Co-produced Documentary \'Northwest from Tumacácori\'': {
    title: 'Coprodujo el Documental \'Northwest from Tumacácori\'',
    desc: 'Coprodujo y coescribió el documental histórico \'Northwest from Tumacácori\'. Este trabajo temprano en medios demostró su interés en alcanzar audiencias más allá de la academia a través de la narrativa visual.'
  },
  '\'Teaching the Chicano Experience\' in Teaching Ethnic Studies': {
    title: '\'Teaching the Chicano Experience\' en Teaching Ethnic Studies',
    desc: 'Contribuyó con el capítulo \'Teaching the Chicano Experience\' al influyente volumen Teaching Ethnic Studies: Concepts and Strategies de James Banks. Cuando el libro de Banks fue ampliamente adoptado para la formación docente, Cortés se encontró lanzado al circuito nacional de conferencias sobre educación multicultural para la educación básica.'
  },
  'Gaúcho Politics in Brazil: The Politics of Rio Grande do Sul, 1930-1964': {
    ...
    desc: 'Publicó su primer libro, una monografía académica que examina la política regional en el estado más meridional de Brasil. Recibió el Premio Memorial Hubert Herring del Pacific Coast Council on Latin American Studies; publicado en Brasil en 2007 como Política Gaúcha.'
  },
  'Edited The Mexican American, The Chicano Heritage, and Hispanics in the United States Reprint Series': {
    title: 'Editó las Series de Reimpresión The Mexican American, The Chicano Heritage e Hispanics in the United States',
    desc: 'Editó The Mexican American (serie de reimpresión de 21 volúmenes) para Arno Press, seguida en 1976 por The Chicano Heritage (55 volúmenes) y en 1980 por Hispanics in the United States (30 volúmenes). Estas series de reimpresión curadas hicieron accesibles investigaciones fundamentales a nuevas generaciones de investigadores y estudiantes.'
  },
  'Co-organized First California Statewide Bilingual Education Conference': {
    title: 'Coorganizó la Primera Conferencia Estatal de Educación Bilingüe de California',
    desc: 'Coorganizó la primera conferencia estatal de educación bilingüe de California en UCR. La conferencia condujo a la formación de la California Association for Bilingual Education (CABE).'
  },
  'UCR Distinguished Teaching Award': {
    title: 'Premio de Excelencia en la Enseñanza de UCR',
    desc: 'Recibió el Premio de Excelencia en la Enseñanza de UCR. Reconocido por la excelencia en el aula durante un período de innovación curricular pionera en UC Riverside.'
  },
  'Co-edited Three Perspectives on Ethnicity: Blacks, Chicanos, and Native Americans': {
    title: 'Coeditó Three Perspectives on Ethnicity: Blacks, Chicanos, and Native Americans',
    desc: 'Coeditó una antología que examina la etnicidad a través de las perspectivas distintas de las experiencias afroamericana, chicana y nativa americana. Uno de los primeros esfuerzos académicos en analizar la identidad étnica de múltiples grupos dentro de un solo marco analítico.'
  },
  '\'The Societal Curriculum and the School Curriculum: Allies or Antagonists?\'': {
    ...
    desc: 'Publicó el influyente artículo que introdujo el concepto del \'currículo societal\' — la educación informal que ocurre a través de los medios de comunicación, las instituciones y las interacciones sociales fuera de la escolarización formal. Ampliamente adoptado en la literatura de educación multicultural, el concepto ayudó a los educadores a comprender su trabajo dentro de contextos sociales más amplios.'
  },
  'Distinguished California Humanist Award': {
    title: 'Premio de Humanista Distinguido de California',
    desc: 'Recibió el Premio de Humanista Distinguido de California del California Council for the Humanities. Reconocimiento a sus contribuciones a la comprensión pública de la cultura y la diversidad.'
  },
  ...
  'Began Teaching History of the Mass Media at UCR': {
    ...
    desc: 'Comenzó a impartir un curso anual, Historia de los Medios de Comunicación Masiva, en UCR. Este nuevo enfoque docente marcó el inicio de su compromiso sostenido con la alfabetización mediática y el papel de los medios en la comprensión pública de la diversidad.'
  },
  ...
  'Wrote PBS Documentary \'Latinos: A Growing Voice in U.S. Politics\'': {
    ...
    desc: 'Escribió el documental de PBS \'Latinos: A Growing Voice in U.S. Politics\'. Llevó el análisis académico sobre la participación política latina a una audiencia televisiva nacional.'
  },
  'Columnist, Media & Values Magazine': {
    title: 'Columnista de la Revista Media & Values',
    desc: 'Comenzó como columnista de la revista Media & Values: A Quarterly Review of Media Issues and Trends, continuando hasta 1990. Escribió regularmente sobre el papel de los medios en la formación de actitudes sobre diversidad y estereotipos.'
  },
  'Helped Establish Costo Chair and Costo Library at UCR': {
    title: 'Ayudó a Establecer la Cátedra Costo y la Biblioteca Costo en UCR',
    desc: 'Ayudó a establecer la Cátedra Rupert y Jeannette Costo en Historia Indígena Americana y la Biblioteca Costo del Indígena Americano en las Colecciones Especiales de la Biblioteca de UCR. Contribuyó a construir la infraestructura institucional para los estudios nativos americanos en UCR.'
  },
  'Co-authored Beyond Language: Social and Cultural Factors in Schooling Language Minority Students': {
    ...
    desc: 'Coautor de esta influyente publicación del Departamento de Educación del Estado de California que examina los factores sociales y culturales que afectan a los estudiantes de minorías lingüísticas. Presentó un \'modelo de interacción contextual\' que influyó en las políticas y prácticas de educación bilingüe.'
  },
  'Japan Foundation Fellow': {
    title: 'Becario de la Fundación Japón',
    desc: 'Pasó cuatro semanas en Japón como Becario de la Fundación Japón. Amplió su perspectiva internacional sobre cómo las sociedades abordan la diversidad cultural y la comunicación intercultural.'
  },
  ...
  'Faculty, Harvard Summer Institutes for Higher Education': {
    ...
    desc: 'Se convirtió en miembro del cuerpo docente de los Institutos de Verano de Harvard para la Educación Superior. Llevó su experiencia en educación multicultural a los programas de desarrollo profesional de Harvard para líderes de educación superior.'
  },
  ...
  'UCR Faculty Public Service Award': {
    ...
    desc: 'Recibió el Premio de Servicio Público del Cuerpo Docente de UCR. Reconocido por su amplio compromiso comunitario y sus contribuciones públicas más allá del trabajo académico tradicional.'
  },
  'National Panel, AAC American Commitments Project': {
    title: 'Panel Nacional, Proyecto American Commitments de la AAC',
    desc: 'Nombrado al Panel Nacional del proyecto de la Asociación de Colegios Americanos, American Commitments: Diversity, Democracy, and Liberal Learning. Ayudó a dar forma a las conversaciones nacionales sobre diversidad en la educación superior.'
  },
  ...
  'Took Early Retirement from the University of California': {
    ...
    desc: 'Se jubiló anticipadamente de la Universidad de California. Lejos de desacelerar, su carrera posterior a la jubilación resultó ser una de sus décadas más productivas.'
  },
  ...
  'Faculty, University of Maryland Civicus Living-Learning Program': {
    ...
    desc: 'Se convirtió en miembro del cuerpo docente del Departamento de Vida Residencial y el Programa de Aprendizaje Vivencial Civicus de la Universidad de Maryland, College Park. Contribuyó a un programa residencial innovador que integra el compromiso cívico con el estudio académico.'
  },
  'The Children Are Watching: How the Media Teach about Diversity': {
    ...
    desc: 'Publicó este análisis innovador sobre cómo los medios de comunicación masiva — televisión, cine, noticias, publicidad — educan a los espectadores sobre la diversidad. El libro estableció a Cortés como una voz líder en la comprensión de la función pedagógica de los medios y es ampliamente citado tanto en educación sobre diversidad como en estudios de medios.'
  },
  ...
  'Outstanding Contribution to Higher Education Award, NASPA': {
    ...
    desc: 'Recibió el Premio a la Contribución Sobresaliente a la Educación Superior de la Asociación Nacional de Administradores de Personal Estudiantil (NASPA). Reconocimiento a sus décadas de trabajo mejorando las prácticas de diversidad en colegios y universidades.'
  },
  ...
  'The Making — and Remaking — of a Multiculturalist': {
    ...
    desc: 'Publicó este memorial educativo autobiográfico que traza su trayectoria personal y profesional en la educación multicultural. El libro demuestra cómo su historia personal refleja la trayectoria más amplia del movimiento de educación multicultural.'
  },
  ...
  'UCR Emeritus Faculty Award': {
    ...
    desc: 'Recibió el Premio al Docente Emérito de UCR. Reconocido por sus continuas contribuciones académicas después de su jubilación de la enseñanza activa.'
  },
  'Co-authored Houghton Mifflin and McDougal Littell Textbook Series': {
    title: 'Coautor de las Series de Libros de Texto de Houghton Mifflin y McDougal Littell',
    desc: 'Coautor de la serie de libros de texto de Estudios Sociales K-6 de Houghton Mifflin y la serie de libros de texto de Historia Mundial de McDougal Littell. Llevó perspectivas multiculturales a materiales educativos convencionales que llegaron a millones de estudiantes.'
  },
  ...
  'Honorary Doctorate, College of Wooster': {
    ...
    desc: 'Recibió un doctorado honorario del College of Wooster. Reconocimiento a sus distinguidas contribuciones a la educación multicultural y los estudios sobre diversidad.'
  },
  'NAACP Image Award': {
    title: 'Premio NAACP Image',
    desc: 'Recibió el Premio NAACP Image por su trabajo como Asesor Creativo/Cultural en los programas de Nickelodeon. El premio reconoció sus contribuciones a la representación positiva de las personas de color en los medios infantiles.'
  },
  ...
  'Co-authored Musical \'We Are Not Alone: Tomás Rivera\'': {
    ...
    desc: 'Coautor del libreto y las letras y coproductor (con Juan Felipe Rivera) del musical \'We Are Not Alone: Tomás Rivera, a Musical Narrative\', con música de Bruno Louchouarn. Extendió su trabajo creativo al teatro musical honrando a un ícono literario chicano.'
  },
  ...
  'Editor, Multicultural America: A Multimedia Encyclopedia (4 volumes)': {
    ...
    desc: 'Editó la enciclopedia Multicultural America en cuatro volúmenes para SAGE Publications, que contiene más de 900 entradas de académicos de diversas disciplinas. Entre las primeras grandes obras de referencia en utilizar extensivamente los datos del Censo de EE.UU. de 2010 para analizar el multiculturalismo.'
  },
  ...
  'Carlos E. Cortés Diversity and Inclusion Award Established': {
    ...
    desc: 'La ciudad de Riverside estableció el Premio Carlos E. Cortés de Diversidad e Inclusión. El primer premio de este tipo en Riverside honra a individuos que encarnan sus valores de inclusión como puente entre comunidades.'
  },
  'Named Edward A. Dickson Emeritus Professor, UCR': {
    title: 'Nombrado Profesor Emérito Edward A. Dickson, UCR',
    desc: 'Nombrado Profesor Emérito Edward A. Dickson en la Universidad de California, Riverside. Este distinguido título de cátedra dotada reconoció sus excepcionales contribuciones a la investigación y el servicio público después de su jubilación.'
  },
  'Fourth Quarter: Reflections of a Cranky Old Man': {
    title: 'Fourth Quarter: Reflections of a Cranky Old Man',
    desc: 'Publicó su primer libro de poesía, reflexionando sobre la vida como octogenario con ingenio y honestidad sin reservas. Recibió Mención Honorífica en la competencia de los International Latino Book Awards por Mejor Libro de Poesía.'
  },
  ...
  'Played \'Big Bad Wolf\' in LA Reading of \'The Shit Show\'': {
    ...
    desc: 'Interpretó al \'Lobo Feroz\' en una lectura pública en Los Ángeles de \'The Shit Show\' de Leelee Jackson. Demostró su continuo entusiasmo por la actuación teatral y la colaboración creativa.'
  },
  ...
  'Riverside Anti-Racism Vision Statement': {
    ...
    desc: 'Coordinó el desarrollo y redactó una declaración de visión antirracista de dos páginas para la ciudad de Riverside, adoptada 6-1 por el Concejo Municipal el 20 de octubre de 2020. El proceso de creación ejemplificó su compromiso con métodos transparentes e inclusivos para la comunidad.'
  },
  ...
  'Consulting Humanist, Cheech Marin Center for Chicano Art and Culture': {
    ...
    desc: 'Se convirtió en Humanista Consultor del Centro Cheech Marin de Arte y Cultura Chicana en Riverside. Conduce \'Conversaciones en The Cheech\' filmadas, explorando el arte y la cultura chicana con artistas y miembros de la comunidad.'
  },
  'A Conversation with Alana: One Boy\'s Multicultural Rite of Passage (Published Book)': {
    title: 'A Conversation with Alana: One Boy\'s Multicultural Rite of Passage (Libro Publicado)',
    desc: 'Publicó su obra autobiográfica unipersonal en formato de libro. Hizo accesible la obra teatral ampliamente presentada a lectores más allá del circuito de actuaciones en vivo.'
  },
  'Teachers Pay Teachers Content Moderation Task Force': {
    title: 'Grupo de Trabajo de Moderación de Contenido de Teachers Pay Teachers',
    desc: 'Nombrado al Grupo de Trabajo de Moderación de Contenido de Teachers Pay Teachers. Aportó su experiencia en diversidad para dar forma a los estándares de contenido de una de las plataformas de recursos docentes más grandes.'
  },
  'Cultural Consultant, \'Puss in Boots: The Last Wish\' (DreamWorks)': {
    title: 'Consultor Cultural, \'El Gato con Botas: El Último Deseo\' (DreamWorks)',
    desc: 'Se desempeñó como consultor cultural para la película nominada al Premio de la Academia \'El Gato con Botas: El Último Deseo\' de DreamWorks Animation. Continuó su patrón de asegurar una representación cultural latina auténtica en el entretenimiento convencional.'
  },
  '\'Renewing Multicultural Education: An Ancient Mariner\'s Manifesto\'': {
    ...
    desc: 'Publicó este influyente artículo en Multicultural Perspectives, adaptado de su discurso principal en la conferencia NAME de 2024. Hizo un llamado a regresar a los principios fundadores de la educación multicultural de la década de 1970: inclusión como puente entre comunidades, diálogo desinhibido y visión optimista.'
  },
  'Scouts\' Honor (Novel)': {
